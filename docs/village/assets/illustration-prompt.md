# Kobold Village Governance Illustration Prompt

Create a wide 16:10 fantasy parchment infographic in the same playful hand-illustrated medieval-fantasy visual language as the supplied Kobold Village reference image: warm aged parchment, decorative corner filigree, dark navy serif title, colorful cute kobold character medallions, crisp readable labels, hand-inked arrows, restrained palette of navy, purple, teal, ochre, moss green, and red prohibition marks.

Title: **Kobold Village Governance Network**
Subtitle: **Governance can challenge sideways. Execution authority flows downward.**
...
Below the Mines, show an **Airlock** pipeline:
`Draft PR -> Warden gates -> Shaman Gate 2 -> Human Ready decision -> CI + E2E -> Main`
...
- Taskmaster receives approved execution plans rather than interpreting the Library independently.
- Shaman may ask the Human Maintainer questions before execution.

Include a small parchment motto panel:
**Many voices. Clear roles. Shared purpose. Stronger village.**

Include a small "Dragon is real" badge listing: cost, latency, context, CI minutes, human attention.

Keep the composition fun, readable, coherent, and slightly whimsical, but it must still function as a serious systems-governance diagram.
