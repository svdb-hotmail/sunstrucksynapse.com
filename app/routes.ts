...
export default [
  ...
  route("submit/:invitationToken/review-audio/:sessionId?", "routes/submission-review-audio.ts"),
  ...
  route("curator/review-audio/:audioId", "routes/curator-review-audio.ts"),
